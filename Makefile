...
.PHONY: all   up down re   mariadb wordpress nginx   enter_mariadb enter_wordpress   logs logs_mariadb logs_wordpress logs_nginx   build_volumes ls_volumes clean_volumes clean_env
